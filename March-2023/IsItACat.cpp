...
void solve() {
    ...
    rep(i,0,n) {
        if(s[i] == 'm' || s[i] == 'M') m=1;
        else if((s[i] == 'e' || s[i] == 'E') && m) e=1;
        else if((s[i] == 'o' || s[i] == 'O') && e) o=1;
        else if((s[i] == 'w' || s[i] == 'W' && o)) w=1;
        else p=0;

        if((s[i] == 'm' || s[i] == 'M') && (e || o || w)) p=0;
        if((s[i] == 'e' || s[i] == 'E') && (o || w)) p=0;
        if((s[i] == 'o' || s[i] == 'O') && (w)) p=0;
    }
    (m&&e&&o&&w&&p) ? printf("YES\n") : printf("NO\n");
}
