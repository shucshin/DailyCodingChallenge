...
int main() {
    ...
    Solution sol;
    vi v1 = {4,5,6,7,0,1,2}, v2 = {0,1,6,3,2,8}, v3 = {1,3,204,2,1}, v4 = {1};
    cout << sol.search(v1, 0) << endl;
    cout << sol.search(v1, 3) << endl;
    cout << sol.search(v2, 3) << endl;
    cout << sol.search(v3, 204) << endl;
    cout << sol.search(v4, 0) << endl;
    return 0;
}